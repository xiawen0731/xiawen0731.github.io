...
![image](https://xiawen0731.github.io/images/concurrent/Synchronize-1.jpg)
...
![image](https://xiawen0731.github.io/images/concurrent/Synchronize-2.jpg)


对象头信息是与对象自身定义的数据无关的额外存储成本，但是考虑到虚拟机的空间效率，Mark Word被设计成一个非固定的数据结构以便在极小的空间内存存储尽量多的数据，它会根据对象的状态复用自己的存储空间，也就是说，Mark Word会随着程序的运行发生变化，变化状态如下（32位虚拟机）：

![image](https://xiawen0731.github.io/images/concurrent/Synchronize-3.jpg)
...
![image](https://xiawen0731.github.io/images/concurrent/Synchronize-4.jpg)
...
![image](https://xiawen0731.github.io/images/concurrent/Synchronize-5.jpg)
...
![image](https://xiawen0731.github.io/images/concurrent/Synchronize-6.jpg)
...
![image](https://xiawen0731.github.io/images/concurrent/Synchronize-7.jpg)
